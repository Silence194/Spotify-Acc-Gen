...
|  $$$$$$/| $$$$$$$/|  $$$$$$/  |  $$$$/| $$| $$     |  $$$$$$$
 \______/ | $$____/  \______/    \___/  |__/|__/      \____  $$
          ...
          | $$                                       |  $$$$$$/
          |__/                                        \______/ 
 {y}Made By https://solo.to/jeremyfragrance
 .gg/alt-gen{re}   
    ''')
...
def mainfunction():
    ...
    if x == "y":
        while True:
            number = 0
            Email = random_char(17)+"@gmail.com"
            password = random_char(5)+"ChaCha-1992"
            ...
            print(f"[{g}WORKING{y}{re}] " + Email + ":" + password + " (SAVED)")
...
#made by 𝒮𝒾𝓁𝑒𝓃𝒸𝑒#6969
#coding Python
#info Made By https://solo.to/jeremyfragrance
